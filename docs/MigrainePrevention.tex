...
\addcontentsline{toc}{subsection}{``삽화편두통 예방치료약물''에 대한 임상진료지침 발간을 축하하며}
...
\section{핵심질문 2.}\label{section-11}}

\hypertarget{section-12}{%
\subsubsection*{성인 삽화편두통 환자에서 예방치료의 중단은 어떻게 결정해야 하는가?}\label{section-12}}
...
\section{핵심질문 3.}\label{section-13}}

\hypertarget{section-14}{%
\subsubsection*{성인 삽화편두통 환자에서 예방치료로 베타차단제를 사용하는 것이 타약제, 위약 또는 치료하지 않는 것에 비해 두통의 완화에 효과적인가?}\label{section-14}}
...
\section{핵심질문 6.}\label{section-18}}

\hypertarget{section-19}{%
\subsubsection*{성인 삽화편두통 환자에서 예방치료로 항우울제를 사용하는 것이 타약제, 위약 또는 치료하지 않는 것에 비해 두통의 완화에 효과적인가?}\label{section-19}}
...
\section{핵심질문 7.}\label{section-20}}

\hypertarget{section-21}{%
\subsubsection*{성인 삽화편두통 환자에서 예방치료로 뇌전증약을 사용하는 것이 타약제, 위약 또는 치료하지 않는 것에 비해 두통의 완화에 효과적인가?}\label{section-21}}
...
\section*{무조짐 편두통}\label{section-27}}
...
\section*{조짐 편두통}\label{section-28}}
...
\chapter{지침 개발 과정}\label{section-29}}

\hypertarget{section-30}{%
\section{이해당사자의 참여}\label{section-30}}

\hypertarget{section-31}{%
\subsection{지침 제정 참여자및 역할}\label{section-31}}

\hypertarget{section-32}{%
\subsubsection*{운영위원회}\label{section-32}}
...
\subsubsection*{자문위원회}\label{section-33}}
...
\subsubsection*{외부자문그룹}\label{section-34}}
...
\subsubsection*{실무위원회및 근거평가그룹}\label{section-35}}
...
\subsection{이해관계 선언}\label{section-36}}

운영위원회및 실무위원회의 모든 위원은 자문료, 연구비, 지적재산권드의 재정적 이해상충, 지적이해상충, 그리고 개인적 이해상충을 문서로 공개하였다.

\hypertarget{section-37}{%
\subsection{운영}\label{section-37}}

\hypertarget{section-38}{%
\subsubsection*{합의원칙의 결정}\label{section-38}}
...
\subsubsection*{저자원칙의 결정}\label{section-39}}
...
\section{지침이 다루는 인구 집단}\label{section-40}}
...
\section{핵심질문}\label{section-51}}

\hypertarget{section-52}{%
\subsection{선정과정}\label{section-52}}
...
\subsection{최종 선정된 핵심질문}\label{section-53}}
...
\chapter{개발의 엄격성}\label{section-54}}

\hypertarget{section-55}{%
\section{개발방법}\label{section-55}}
...
\section{지침및 근거검색}\label{section-56}}
...
\section{검색된 진료지침및 연구결과 선별}\label{section-57}}
...
\section{검색된 진료지침및 연구결과 평가}\label{section-58}}
...
\section{권고문 합의및 권고등급 결정}\label{section-59}}
...
\subsubsection*{근거수준}\label{section-60}}
...
\subsubsection*{권고등급}\label{section-61}}
