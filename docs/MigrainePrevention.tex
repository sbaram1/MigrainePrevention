...
\section{일반적인 용량}\label{section-23}}

\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-7}베타차단제}\\
\toprule
약물 & 용량범위\\
\midrule
프로프라놀롤 & 10-80mg b.i.d.\\
메토프롤롤 & 25-100mg b.i.d.\\
아테놀롤 & 25-100mg b.i.d.\\
나돌롤 & 40-80mg b.i.d.\\
네비볼롤 & 2.5-5mg q.d.\\
\addlinespace
비소프롤롤 & 1.25-10mg q.d.\\
핀돌롤 & 5-30mg qd or b.i.d.\\
\bottomrule
\end{longtable}

\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-8}칼슘통로차단제}\\
\toprule
약물 & 용량범위\\
\midrule
플루나리진 & 5-10mg q.d. or b.i.d.\\
신나리진 & 25mg b.i.d.\\
베라파밀 & 80-640mg q.d. or b.i.d.\\
니카르디핀 & 20-40mg b.i.d.\\
니페디핀 & 15-60mg per day\\
\addlinespace
니모디핀 & 30mg t.i.d.\\
\bottomrule
\end{longtable}
...
\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-9}안지오텐신수용체 또는 전환효소억제제}\\
\toprule
약물 & 용량범위\\
\midrule
칸데사르탄 & 4-16mg q.d.(32mg까지 증량 가능)\\
리시노프릴 & 10-20mg q.d.\\
텔미사르탄 & 40-80mg q.d.\\
\bottomrule
\end{longtable}
...
\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-10}항우울제}\\
\toprule
약물 & 용량범위\\
\midrule
아미트리프틸린 & 2.5-50mg q.d.\\
벤라팍신 & 27.5 - 150mg q.d.\\
플루옥세틴 & 10-80mg q.d.\\
노르트리프틸린 & 25-150mg/d (노인은 절반용량)\\
\bottomrule
\end{longtable}

\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-11}뇌전증약}\\
\toprule
약물 & 용량범위\\
\midrule
토피라메이트 & 20-50mg b.i.d.\\
디발프로엑스나트륨 & 300-1000mg b.i.d.\\
발프로산 & 300-1000mg b.i.d.\\
가바펜틴 & 100-600mg t.i.d.\\
레베티라세탐 & 250-1000mg b.i.d.\\
\addlinespace
조니사미드 & 100-600mg/d\\
\bottomrule
\end{longtable}
...
\section{흔한 부작용}\label{section-24}}

\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-12}베타차단제}\\
\toprule
약물 & 부작용\\
\midrule
프로프라놀롤 & 피로감, 어지럼증 가역성 우울증, 생생한 꿈\\
메토프롤롤 & 피로감, 어지럼증 가역성 우울증, 생생한 꿈\\
아테놀롤 & 피로감, 어지럼증 가역성 우울증, 생생한 꿈, 숨참, 서맥 또는 심계항진, 구역\\
나돌롤 & 피로감, 어지럼증 가역성 우울증, 생생한 꿈, 숨참, 서맥 또는 심계항진, 구역\\
네비볼롤 & 두통, 어지럼증, 감각이상, 악몽, 위장장애, 호흡곤란, 가려움증, 부종\\
\addlinespace
비소프롤롤 & 서맥, 두통, 어지럼증, 오심, 구토, 설사, 변비, 피로\\
핀돌롤 & 불면증, 어지럼증, 피로, 악몽, 소화불량, 호흡곤란, 근육통, 관절통\\
\bottomrule
\end{longtable}

\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-12}칼슘통로차단제}\\
\toprule
약물 & 부작용\\
\midrule
플루나리진 & 체중증가, 졸림, 입마름, 어지럼, 저혈압, 우울증\\
신나리진 & 체중증가, 졸림, 입마름, 어지럼, 저혈압, 우울증\\
베라파밀 & 심계항진, 부종, 부정맥, 발진\\
니카르디핀 & 변비, 안면홍조, 무력, 구통, 근육통, 진전, 어지럼증\\
니페디핀 & 변비, 안면홍조, 무력, 구통, 근육통, 진전, 어지럼증\\
\addlinespace
니모디핀 & 위장장애, 두통, 현기증, 졸음, 진전\\
\bottomrule
\end{longtable}

\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-12}안지오텐신수용체 또는 전환효소억제제}\\
\toprule
약물 & 부작용\\
\midrule
칸데사르탄 & 저혈압, 울혈심부전의 악화\\
리시노프릴 & 어지럼, 두통, 기침, 피로감, 근육경련, 설사, 저혈압\\
텔미사르탄 & 고칼륨혈증, 어지럼증, 저혈압, 발진, 근육통\\
\bottomrule
\end{longtable}

\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-12}항우울제}\\
\toprule
약물 & 부작용\\
\midrule
아미트리프틸린 & 체중증가, 변비, 무력증, 어지럼증, 졸림, 피로감, 시야흐림, 입마름\\
벤라팍신 & 졸림, 불면증, 어지럼, 두통, 발한, 구역, 입마름, 신경질, 불안, 비정상사정, 발기부전, 성욕감퇴\\
플루옥세틴 & 무력증, 구역, 설사, 불면증, 식욕부진, 발기부전, 떨림, 불안, 초초\\
노르트리프틸린 & 체중증가, 변비, 무력증, 어지럼증, 졸림, 피로감, 시야흐림, 입마름\\
\bottomrule
\end{longtable}

\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-12}뇌전증약}\\
\toprule
약물 & 부작용\\
\midrule
토피라메이트 & 감각이상, 체중감소, 기억장애\\
디발프로엑스나트륨 & 구역, 체중증가, 떨림, 탈모, 졸림, 어지럼증, 구토, 약물상호작용\\
발프로산 & 구역, 체중증가, 떨림, 탈모, 졸림, 어지럼증, 구토, 약물상호작용\\
가바펜틴 & 말초부종, 어지럼, 졸림, 실조증, 체중증가\\
레베티라세탐 & 무력증, 피로, 졸음, 어지럼증, 근육통, 복시, 발진, 기침\\
\addlinespace
조니사미드 & 체중감소, 복시/시각장애, 졸림, 의욕저하\\
\bottomrule
\end{longtable}
...
\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-13}베타차단제}\\
\toprule
약물 & 금기사항\\
\midrule
프로프라놀롤 & 심한 천식, 당뇨병, 말초혈관병, 심장전도장애, 울혈성심부전\\
메토프롤롤 & 심한 천식, 당뇨병, 말초혈관병, 심장전도장애, 울혈성심부전\\
아테놀롤 & 심한 천식, 당뇨병, 말초혈관병, 심장전도장애, 울혈성심부전, 치료되지 않은 크롬친화성세포종\\
나돌롤 & 심한 천식, 당뇨병, 말초혈관병, 심장전도장애, 울혈성심부전, 모노아민산화효소억제제 사용(2주이내), 임신\\
네비볼롤 & 심한 천식, 말초혈관병, 심장전도장애, 울혈성심부전\\
\addlinespace
비소프롤롤 & 서맥, 당뇨병성 케토산증, 급성 심부전, 임신상태, 치료받지 않은 크롬친화성세포종, 중증의 천식 또는 만성 폐색성 폐질환 환자\\
핀돌롤 & 천식, 중증 심부전, 서맥, 부정맥, 임신상태, 수유 중\\
\bottomrule
\end{longtable}

\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-13}칼슘통로차단제}\\
\toprule
약물 & 금기사항\\
\midrule
플루나리진 & 심한 우울증, 파킨슨병 기타 피라미드외로 증상\\
신나리진 & 심한 우울증, 파킨슨병 기타 피라미드외로 증상\\
베라파밀 & 서맥, 심장전도장애, 동결절기능부전 증후군, 중증근무력증, 급성심근경색\\
니카르디핀 & 과민증병력, 두개내출혈 후 지혈되지 않은 상태, 뇌졸중 급성기로 두개내압상승상태, 심근경색, 중증신질환, 대동맥판막협착증, 임신\\
...
\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-13}안지오텐신수용체 또는 전환효소억제제}\\
\toprule
약물 & 금기사항\\
\midrule
칸데사르탄 & 혈관부종병력, 임신, 수유\\
...
\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-13}항우울제}\\
\toprule
약물 & 금기사항\\
\midrule
아미트리프틸린 & 심근경색의 급성회복기, cisapride 사용, 모노아민산화효소억제제 사용, 삼환계항우울제에 대한 과민\\
벤라팍신 & 모노아민산화효소억제제 동시사용, 수유중인 여성 주의\\
플루옥세틴 & 모노아민산화효소억제제 동시사용, thioridazine, pimozied등 동시사용\\
노르트리프틸린 & 심근경색후 급성회복기, cisapride 사용, 모노아민산화효소억제제 사용, 삼환계항우울제에 대한 과민\\
\bottomrule
\end{longtable}

\begin{longtable}{llllll}
\caption{\label{tab:unnamed-chunk-13}뇌전증약}\\
\toprule
약물 & 금기사항\\
\midrule
...
\chapter{편두통 진단기준}\label{section-26}}

\hypertarget{section-27}{%
\chapter{개발그룹}\label{section-27}}

\hypertarget{section-28}{%
\section{운영위원회}\label{section-28}}
...
\section{자문위원회}\label{section-29}}
...
\section{외부자문그룹}\label{section-30}}
...
\section{실무위원회및 근거평가그룹}\label{section-31}}
...
\section{이해관계 선언}\label{section-32}}

운영위원회및 실무위원회의 모든 위원은 자문료, 연구비, 지적재산권드의 재정적 이해상충, 지적이해상충, 그리고 개인적 이해상충을 문서로 공개하였다.

\hypertarget{section-33}{%
\section{운영}\label{section-33}}

\hypertarget{section-34}{%
\subsection{합의원칙의 결정}\label{section-34}}
...
\subsection{저자원칙의 결정}\label{section-35}}
...
\subsection{잠재적 승인기구}\label{section-36}}
...
\subsection{보급전략}\label{section-37}}
...
\chapter{개발 계획}\label{section-38}}

\hypertarget{section-39}{%
\section{기존 진료지침 검색}\label{section-39}}
...
\chapter{범위결정과 핵심질문}\label{section-41}}

\hypertarget{section-42}{%
\section{범위결정}\label{section-42}}
...
\chapter{지침및 근거검색}\label{section-43}}

\includegraphics{static/SearchProcess.png}

\hypertarget{section-44}{%
\section{지침검색}\label{section-44}}
...
\section{핵심질문별 근거 평가자}\label{section-46}}
...
\chapter{삽화성편두통 예방 진료지침}\label{section-47}}

\hypertarget{section-48}{%
\chapter{외부전문가 리뷰}\label{section-48}}

\hypertarget{section-49}{%
\chapter{지침 수정 계획과 발표}\label{section-49}}
