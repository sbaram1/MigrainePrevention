...
\caption{\label{tab:unnamed-chunk-1}베타차단제}\\
\toprule
약물 & 근거수준 & 권고등급 & 권고사항\\
\midrule
프로프라놀롤 & 높음 & 강함 & 권고함\\
...
\begin{longtable}{lccclccclccclccc}
\caption{\label{tab:unnamed-chunk-2}칼슘통로차단제}\\
\toprule
약물 & 근거수준 & 권고등급 & 권고사항\\
\midrule
...
\begin{longtable}{lccclccclccclccc}
\caption{\label{tab:unnamed-chunk-3}안지오텐신수용체 또는 전환효소억제제}\\
\toprule
약물 & 근거수준 & 권고등급 & 권고사항\\
\midrule
...
\begin{longtable}{lccclccclccclccc}
\caption{\label{tab:unnamed-chunk-4}항우울제}\\
\toprule
약물 & 근거수준 & 권고등급 & 권고사항\\
\midrule
아미트리프틸린 & 보통 & 강함 & 권고함\\
...
\begin{longtable}{lccclccclccclccc}
\caption{\label{tab:unnamed-chunk-5}뇌전증약}\\
\toprule
약물 & 근거수준 & 권고등급 & 권고사항\\
\midrule
토피라메이트 & 높음 & 강함 & 권고함\\
...
\begin{longtable}{lccclccclccclccc}
\caption{\label{tab:unnamed-chunk-6}베타차단제}\\
\toprule
약물 & 용량범위 & 부작용 & 금기사항\\
\midrule
프로프라놀롤 & 10-80mg b.i.d. & 피로감, 어지럼증 가역성 우울증, 생생한 꿈 & 심한 천식, 당뇨병, 말초혈관병, 심장전도장애, 울혈성심부전\\
메토프롤롤 & 25-100mg b.i.d. & 피로감, 어지럼증 가역성 우울증, 생생한 꿈 & 심한 천식, 당뇨병, 말초혈관병, 심장전도장애, 울혈성심부전\\
아테놀롤 & 25-100mg b.i.d. & 피로감, 어지럼증 가역성 우울증, 생생한 꿈, 숨참, 서맥 또는 심계항진, 구역 & 심한 천식, 당뇨병, 말초혈관병, 심장전도장애, 울혈성심부전, 치료되지 않은 크롬친화성세포종(알파차단제 병용필요)\\
나돌롤 & 40-80mg b.i.d. & 피로감, 어지럼증 가역성 우울증, 생생한 꿈, 숨참, 서맥 또는 심계항진, 구역 & 심한 천식, 당뇨병, 말초혈관병, 심장전도장애, 울혈성심부전, 모노아민산화효소억제제 사용(2주이내), 임신상태\\
네비볼롤 & 2.5-5mg q.d. & 두통, 어지럼증, 감각이상, 악몽, 위장장애, 호흡곤란, 가려움증, 부종 & 심한 천식, 말초혈관병, 심장전도장애, 울혈성심부전\\
\addlinespace
비소프롤롤 & 1.25-10mg q.d. & 서맥, 두통, 어지럼증, 오심, 구토, 설사, 변비, 피로 & 서맥, 당뇨병성 케토산증, 급성 심부전, 임신상태, 치료받지 않은 크롬친화성세포종, 중증의 천식 또는 만성 폐색성 폐질환 환자\\
핀돌롤 & 5-30mg qd or b.i.d. & 불면증, 어지럼증, 피로, 악몽, 소화불량, 호흡곤란, 근육통, 관절통 & 천식, 중증 심부전, 서맥, 부정맥, 임신상태, 수유 중\\
\bottomrule
\end{longtable}

\begin{longtable}{lccclccclccclccc}
\caption{\label{tab:unnamed-chunk-7}칼슘통로차단제}\\
\toprule
약물 & 용량범위 & 부작용 & 금기사항\\
\midrule
플루나리진 & 높음 & 약함 & 고려할 수 있음\\
...
\begin{longtable}{lccclccclccclccc}
\caption{\label{tab:unnamed-chunk-8}안지오텐신수용체 또는 전환효소억제제}\\
\toprule
약물 & 용량범위 & 부작용 & 금기사항\\
\midrule
칸데사르탄 & 보통 & 약함 & 고려할 수 있음\\
...
\begin{longtable}{lccclccclccclccc}
\caption{\label{tab:unnamed-chunk-9}항우울제}\\
\toprule
약물 & 용량범위 & 부작용 & 금기사항\\
\midrule
아미트리프틸린 & 보통 & 강함 & 권고함\\
...
\begin{longtable}{lccclccclccclccc}
\caption{\label{tab:unnamed-chunk-10}뇌전증약}\\
\toprule
약물 & 용량범위 & 부작용 & 금기사항\\
\midrule
토피라메이트 & 높음 & 강함 & 권고함\\
...
\chapter{편두통 진단기준}\label{section-23}}

\hypertarget{section-24}{%
\chapter{개발그룹}\label{section-24}}

\hypertarget{section-25}{%
\section{운영위원회}\label{section-25}}
...
\section{자문위원회}\label{section-26}}
...
\section{외부자문그룹}\label{section-27}}
...
\section{실무위원회및 근거평가그룹}\label{section-28}}
...
\section{이해관계 선언}\label{section-29}}

운영위원회및 실무위원회의 모든 위원은 자문료, 연구비, 지적재산권드의 재정적 이해상충, 지적이해상충, 그리고 개인적 이해상충을 문서로 공개하였다.

\hypertarget{section-30}{%
\section{운영}\label{section-30}}

\hypertarget{section-31}{%
\subsection{합의원칙의 결정}\label{section-31}}
...
\subsection{저자원칙의 결정}\label{section-32}}
...
\subsection{잠재적 승인기구}\label{section-33}}
...
\subsection{보급전략}\label{section-34}}
...
\chapter{개발 계획}\label{section-35}}

\hypertarget{section-36}{%
\section{기존 진료지침 검색}\label{section-36}}
...
\chapter{범위결정과 핵심질문}\label{section-38}}

\hypertarget{section-39}{%
\section{범위결정}\label{section-39}}
...
\chapter{지침및 근거검색}\label{section-40}}

\includegraphics{static/SearchProcess.png}

\hypertarget{section-41}{%
\section{지침검색}\label{section-41}}
...
\section{핵심질문별 근거 평가자}\label{section-43}}
...
\chapter{삽화성편두통 예방 진료지침}\label{section-44}}

\hypertarget{section-45}{%
\chapter{외부전문가 리뷰}\label{section-45}}

\hypertarget{section-46}{%
\chapter{지침 수정 계획과 발표}\label{section-46}}
